...
An Android Studio-based Smart Parking System designed to provide an intuitive interface for users to log in, book parking slots, and give feedback.
This project focuses on building the frontend and user interaction flow of a smart parking solution, with smooth navigation between screens and a modern UI experience.
